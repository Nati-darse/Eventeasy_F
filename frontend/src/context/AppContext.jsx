...
export const AppContextProvider = (props) => {
  ...
  const getUserData = async () => {
    try {
      setError(null);
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL || 'https://event-easy.onrender.com'}/Event-Easy/user/data`, { 
  ...
  const getAuthState = async () => {
    try {
      setError(null);
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL || 'https://event-easy.onrender.com'}/Event-Easy/users/is-auth`, { 
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
  ...
  const logout = async () => {
    try {
      await axios.post(`${import.meta.env.VITE_API_URL || 'https://event-easy.onrender.com'}/Event-Easy/users/logout`, {}, { 
        withCredentials: true 
      });
    } catch (error) {
  ...
  const register = async (userData) => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL || 'https://event-easy.onrender.com'}/Event-Easy/users/register`,
        userData,
        { withCredentials: true }
      );
