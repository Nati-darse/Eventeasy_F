...
const checkEventEasyDB = async () => {
  try {
    console.log('🔍 Connecting to Event-Easy database...');
    await mongoose.connect(MONGO_URI);
    console.log('✅ Connected to Event-Easy database');

    // List all collections
    const collections = await mongoose.connection.db.listCollections().toArray();
    console.log('\n📋 Collections in Event-Easy database:');
